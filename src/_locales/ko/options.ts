  ...
  syncService: {
    ...
    webdav: {
      ...
      exist_confirm_fullSync:
        '서버에 Saladict 디렉터리가 이미 있습니다. 로컬 단어장을 원격 단어장으로 교체할까요? 원격에 없는 로컬 단어는 삭제됩니다.',
      ...
      fullSync: '미러 동기화',
      fullSync_help:
        '활성화하면 더 새로운 원격 단어장을 다운로드할 때 원격에 없는 로컬 단어도 삭제되어 로컬 단어장이 원격과 정확히 일치합니다. 데이터 손실을 방지하기 위해 기본값은 꺼짐(병합 모드)입니다.',
      fullSync_confirm:
        '미러 동기화가 활성화되었습니다. 다음 동기화에서 로컬 단어장이 원격 단어장으로 교체되고 원격에 없는 로컬 단어가 삭제될 수 있습니다. 저장하시겠습니까?',
      passwd: '비밀번호',
      url: '서버 주소',
      user: '계정'
    },
